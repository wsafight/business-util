...
SQLPage 是一个革新性的 SQL-only 网页应用构建工具，它允许开发者通过简单的 SQL 查询语句来创建功能丰富的交互式网站。[参考 0](https://github.com/sqlpage/SQLPage)
...
[参考 0](https://github.com/sqlpage/SQLPage)
...
SQLPage 的核心概念非常简洁：**每个 SELECT 语句都会被分析并渲染为用户界面元素**。[参考 1](https://sql-page.com/documentation.sql)
...
[参考 1](https://sql-page.com/documentation.sql)
