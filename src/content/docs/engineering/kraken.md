---
title: 高性能 Web 渲染引擎 kraken
description: 高性能 Web 渲染引擎 kraken
---

对比其他渲染引擎，kraken 具备很大的优势。一边可以使用 W3C 标准和常用 web 框架（Vue、React 和 Rax），另一方面底层使用 [Flutter](https://flutter.dev/) 来构建。具备强大渲染性能。
