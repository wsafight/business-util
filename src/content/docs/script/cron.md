---
title: 使用 cron 实现定时任务
description: 使用 cron 实现定时任务
---
...
而 [cron-parser](https://github.com/harrisiirak/cron-parser) 可以帮助我们在 node 中使用 cron 实现定时任务。

TODO 尝试 装饰器 + cron 定时任务
